...
* Delivering domain workflows: workstation handover PDFs/e-mails, export enhancements (filtry, expirace odkazů, auditované stažení), reports & schedules, extended connectors (printing), incremental/advanced backup features (např. dedikované storage konektory, incremental snapshoty, archivace) a observability dashboards/alerting.
