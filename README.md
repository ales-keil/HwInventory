...
* Hardening authentication/authorization (SSPR, LDAP/OIDC integration, scoped data filters, CAPTCHA, session management) with auditable scope controls.
