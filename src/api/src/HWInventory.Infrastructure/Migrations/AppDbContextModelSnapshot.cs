...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HWInventory.Domain.Entities.SecurityMetricSnapshot", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uniqueidentifier");
                ...
                b.Property<int>("PendingPasswordResets")
                    .HasColumnType("int");

                b.Property<int>("TotpEnabled")
                    .HasColumnType("int");

                b.Property<int>("TotpRequired")
                    .HasColumnType("int");
                ...
                b.ToTable("SecurityMetricSnapshots");
            });
            ...
            modelBuilder.Entity("HWInventory.Domain.Entities.WorkstationHandoverRequest", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedNever()
                    .HasColumnType("uniqueidentifier");
                ...
                b.Property<string>("DeclineTokenHash")
                    .IsRequired()
                    .HasMaxLength(256)
                    .HasColumnType("nvarchar(256)");
                ...
                b.Property<Guid?>("NewAdminId")
                    .HasColumnType("uniqueidentifier");

                b.Property<Guid?>("NewOwnerId")
                    .HasColumnType("uniqueidentifier");

                b.Property<string>("NewOwnerDepartment")
                    .HasColumnType("nvarchar(max)");

                b.Property<string>("NewOwnerDisplayName")
                    .HasColumnType("nvarchar(max)");

                b.Property<Guid>("NewLocationId")
                    .HasColumnType("uniqueidentifier");

                b.Property<string>("NewLocationName")
                    .HasColumnType("nvarchar(max)");
                ...
                b.Property<string>("OldOwnerDepartment")
                    .HasColumnType("nvarchar(max)");

                b.Property<string>("OldOwnerDisplayName")
                    .HasColumnType("nvarchar(max)");

                b.Property<Guid>("OldLocationId")
                    .HasColumnType("uniqueidentifier");

                b.Property<string>("OldLocationName")
                    .HasColumnType("nvarchar(max)");
                ...
                b.ToTable("WorkstationHandovers");
            });

            modelBuilder.Entity("HWInventory.Domain.Entities.WorkstationHandoverRequest", b =>
            {
                b.HasOne("HWInventory.Domain.Entities.Workstation", "Workstation")
                    .WithMany()
