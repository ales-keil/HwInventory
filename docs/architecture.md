...
* Security controller poskytuje konfiguraci OIDC/LDAP/SSPR, mapování AD skupin, politiku hesel, bezpečnostní alerty včetně konfigurovatelných prahů a historii metrik (`/api/security/alerts|metrics/*`), které napájí React stránku Security Settings.
