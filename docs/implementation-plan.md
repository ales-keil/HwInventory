...
- **Connectors catalogue**
  - Rozšířit REST API a React stránku „Konektory“ o CRUD/editaci profilů pro Database, External SQL, Printing, Observability a Zabbix včetně health-checků, plánovaných ověřování, retry/backoff politik a správy tajemství (aktuální iterace pokrývá SMTP/SMS testy, LDAP/OIDC přehledy, Storage, SFTP/FTPS a Webhooks).
- **Observability**
