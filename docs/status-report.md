...
_Last updated: 2025-10-07T19:30:00Z_
...
- Harden authentication & RBAC: LDAP/AD integration, SSO/OIDC, SSPR with CAPTCHA/SMS, session management, and audit coverage for data-scope changes plus other security events.
