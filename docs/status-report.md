...
_Last updated: 2025-10-08T18:30:00Z_
...
- Complete remaining domain workflows: import/export with dry-run and async jobs, reporting & schedules, rozšířené konektory (SFTP/FTPS, webhooks, storage, printing), backup/restore, updates module, observability dashboards/alerting, and full audit diff surfacing for additional entities.
